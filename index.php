...
if (isset($_GET['result']) && is_numeric($_GET['result']) && $_GET['result'] >= $min && $_GET['result'] <= $max) {
    ...
    <meta property="og:image" content="https://github.com/kscomac/maru/<?php echo $result ?>.jpg">
    ...
    <meta name="twitter:image" content="https://github.com/kscomac/maru/<?php echo $result ?>.jpg">
    <meta name="twitter:url" content="http://localhost/cp_miso_202112/index.php?result=<?php echo $result ?>">
<?php }else{ ?>
    <meta property="og:type" content="article">
