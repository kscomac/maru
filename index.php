...
if (isset($_GET['result']) && is_numeric($_GET['result']) && $_GET['result'] >= $min && $_GET['result'] <= $max) {
    ...
    <meta property="og:image" content="https://github.com/kscomac/maru/<?php echo $pic ?>.jpg">
    ...
    <meta name="twitter:image" content="https://github.com/kscomac/maru/<?php echo $pic ?>.jpg">
